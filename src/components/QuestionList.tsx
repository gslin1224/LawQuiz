...
import { CheckCircle, BookOpen, Search, ChevronDown, ChevronUp } from 'lucide-react';
    ...
    <div className="bg-background">
      <div className="max-w-4xl mx-auto px-4 py-8 space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-muted-foreground">共 {questions.length} 題（含詳解）</p>
        </div>
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full h-12 pl-10 pr-4 rounded-xl border bg-card text-sm focus:outline-none focus:ring-2 focus:ring-primary"
          />
        </div>
          ...
          {filteredQuestions.map((q, idx) => (
            <Card
              ...
              className={cn(
                ...
                expandedId === q.id && "ring-2 ring-primary"
              )}
